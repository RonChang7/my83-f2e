...
.pswp__button--arrow--right:before {
  background: url('#{$image-bucket-url}/front/common/icon/arrow-next.svg') !important;
  right: 40px;
}

.pswp__button--arrow--left:before {
  background: url('#{$image-bucket-url}/front/common/icon/arrow-previous.svg') !important;
  left: 40px;
}
</style>
